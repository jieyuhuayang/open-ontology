...
1. **详情侧边栏职责冲突，架构边界不清**
- **位置**: `design.md:126-138`, `design.md:147`, `design.md:220-225`
...
- **位置**: `spec.md:34-35`（AC6）, `design.md:104-107`, `design.md:258-283`
...
- **位置**: `spec.md:102-103`, `spec.md:110`, `design.md:323-385`
...
4. **路由技术路线描述前后不一致**
- **位置**: `design.md:124-125` vs `design.md:251-289`
...
- **位置**: `spec.md:115`, `design.md:399-413`
...
6. **测试策略与路由实现不匹配**
- **位置**: `design.md:253-285`, `design.md:427`
